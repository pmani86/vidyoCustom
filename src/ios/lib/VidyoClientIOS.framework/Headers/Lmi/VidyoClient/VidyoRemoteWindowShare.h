...
{function:
	...
	{parent: VidyoRemoteWindowShare}
	{description: }
	{prototype: LmiBool VidyoRemoteWindowShareSetPositionInLocalRenderer(const VidyoRemoteWindowShare *w, const VidyoLocalRenderer *localRenderer, LmiInt x, LmiInt y, LmiUint width, LmiUint height, LmiTime frameInterval)}
	{parameter:
		{name: w}
		{description: The VidyoRemoteWindowShare object. }
	}
...
*/
LmiBool VidyoRemoteWindowShareSetPositionInLocalRenderer(const VidyoRemoteWindowShare *w, const VidyoLocalRenderer *localRenderer, LmiInt x, LmiInt y, LmiUint width, LmiUint height, LmiTime frameInterval);
...
{function visibility="private":
	...
	{parent: VidyoRemoteWindowShare}
	{description: }
	{prototype: VidyoRemoteWindowShare *VidyoRemoteWindowShareConstructFromDevice(VidyoRemoteWindowShare* vidyoRemoteWindowShare, const VidyoDevice *device, LmiAllocator* alloc)}
	{parameter:
		{name: vidyoRemoteWindowShare}
		{description: }
	}
...
*/
VidyoRemoteWindowShare *VidyoRemoteWindowShareConstructFromDevice(VidyoRemoteWindowShare* vidyoRemoteWindowShare, const VidyoDevice *device, LmiAllocator* alloc);
