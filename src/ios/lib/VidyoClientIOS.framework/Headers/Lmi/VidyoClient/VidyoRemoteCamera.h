...
{callback apigroup="beta":
	...
	{prototype: void (*VidyoRemoteCameraOnFrameSizeUpdate)(VidyoRemoteCamera* c, const LmiInt width, const LmiInt height)}
	{parameter:
		{name: c}
...
*/
typedef void(*VidyoRemoteCameraOnFrameSizeUpdate)(VidyoRemoteCamera* c, const LmiInt width, const LmiInt height);
...
{function:
	...
	{parent: VidyoRemoteCamera}
	{description: }
	{prototype: LmiVoidPtr VidyoRemoteCameraAddToLocalRenderer(const VidyoRemoteCamera* c, const VidyoLocalRenderer* localRenderer, VidyoRemoteCameraMode mode)}
	{parameter:
		{name: c}
		{description: The VidyoRemoteCamera object. }
	}
...
*/
LmiVoidPtr VidyoRemoteCameraAddToLocalRenderer(const VidyoRemoteCamera* c, const VidyoLocalRenderer* localRenderer, VidyoRemoteCameraMode mode);
