...
/**
   {function:
     ...
     {prototype: LmiSizeT LmiWideStringFindFirstOfCStr(const LmiWideString* x, LmiSizeT pos, const LmiWideChar* y)}
     {parameter:
       {name: x}
       {description: The string to be searched.}}
     {parameter:
     ...
     {parameter:
       {name: y}
       {description: The NUL-terminated C wide string whose characters are to be searched for.}}
...
*/
LmiSizeT LmiWideStringFindFirstOfCStr(const LmiWideString* x, LmiSizeT pos, const LmiWideChar* y);

/**
   {function:
     {name: LmiWideStringFindFirstOfCStrLen}
     {parent: LmiWideString}
     {description: Find first location in a string where one of the
	   characters in a C wide string of a given length occurs.}
     {prototype: LmiSizeT LmiWideStringFindFirstOfCStrLen(const LmiWideString* x, LmiSizeT pos, const LmiWideChar* y, LmiSizeT n)}
     {parameter:
       {name: x}
       {description: The string to be searched.}}
     {parameter:
...
*/
LmiSizeT LmiWideStringFindFirstOfCStrLen(const LmiWideString* x, LmiSizeT pos, const LmiWideChar* y, LmiSizeT n);
...
/**
   {function:
     ...
     {prototype: LmiSizeT LmiWideStringFindFirstNotOfCStr(const LmiWideString* x, LmiSizeT pos, const LmiWideChar* y)}
     {parameter:
       {name: x}
       {description: The string to be searched.}}
     {parameter:
...
*/
LmiSizeT LmiWideStringFindFirstNotOfCStr(const LmiWideString* x, LmiSizeT pos, const LmiWideChar* y);

/**
   {function:
     {name: LmiWideStringFindFirstNotOfCStrLen}
     {parent: LmiWideString}
     {description: Find first location in a string where one of the
	   characters in a C wide string of a given length does not occur.}
     {prototype: LmiSizeT LmiWideStringFindFirstNotOfCStrLen(const LmiWideString* x, LmiSizeT pos, const LmiWideChar* y, LmiSizeT n)}
     {parameter:
       {name: x}
       {description: The string to be searched.}}
     {parameter:
...
*/
LmiSizeT LmiWideStringFindFirstNotOfCStrLen(const LmiWideString* x, LmiSizeT pos, const LmiWideChar* y, LmiSizeT n);

/**
   {function:
     {name: LmiWideStringFindLastOfCStrLen}
     {parent: LmiWideString}
     {description: Find last location in a string where one of the
	   characters in a C wide string of a given length occurs.}
     {prototype: LmiSizeT LmiWideStringFindLastOfCStrLen(const LmiWideString* x, LmiSizeT pos, const LmiWideChar* y, LmiSizeT n)}
     {parameter:
       {name: x}
       {description: The string to be searched.}}
     {parameter:
...
*/
LmiSizeT LmiWideStringFindLastOfCStrLen(const LmiWideString* x, LmiSizeT pos, const LmiWideChar* y, LmiSizeT n);
