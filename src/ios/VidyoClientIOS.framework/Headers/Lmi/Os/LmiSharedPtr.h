...
#define Define_LmiSharedPtrWrapper_Bodies_(I, H, B, BEq, BLess) \
	...
	I H *LmiClassFunc(H, AssignFromSharedVoidPtr)(H *h, const LmiSharedVoidPtr *other) \
	{ \
		if(LmiSharedPtrAssignFromSharedVoidPtr(B)(&h->sp, other) == NULL) \
			return NULL; \
		return h; \
	} \
    ...
    \
	I H *LmiClassFunc(H, ConstructFromSharedImplPtr)(H *h, const LmiSharedPtr(B) *other) \
	{ \
		if(LmiSharedPtrConstructCopy(B)(&h->sp, other) == NULL) \
			return NULL; \
		return h; \
	} \
	I H *LmiClassFunc(H, AssignFromSharedImplPtr)(H *h, const LmiSharedPtr(B) *other) \
	{ \
		if(LmiSharedPtrAssign(B)(&h->sp, other) == NULL) \
			return NULL; \
		return h; \
	} \
	I LmiSharedPtr(B) *LmiClassFunc(H, GetSharedImplPtr)(H *h) \
	{ \
		return &h->sp; \
	} \
	I const LmiSharedPtr(B) *LmiClassFunc(H, GetSharedImplPtrConst)(const H *h) \
	{ \
		return &h->sp; \
	}
...
#define Declare_LmiSharedPtrWrapper(H, B) \
	...
	LMI_INLINE_DECLARATION H *LmiClassFunc(H, AssignFromSharedVoidPtr)(H *h, const LmiSharedVoidPtr *other); \
    ...
    LMI_INLINE_DECLARATION H *LmiClassFunc(H, ConstructFromSharedImplPtr)(H *h, const LmiSharedPtr(B) *other); \
    LMI_INLINE_DECLARATION H *LmiClassFunc(H, AssignFromSharedImplPtr)(H *h, const LmiSharedPtr(B) *other); \
	LMI_INLINE_DECLARATION LmiSharedPtr(B) *LmiClassFunc(H, GetSharedImplPtr)(H *h); \
	LMI_INLINE_DECLARATION const LmiSharedPtr(B) *LmiClassFunc(H, GetSharedImplPtrConst)(const H *h);
