...
/**
	{function:
		...
		{prototype: LmiFile* LmiFileConstructDefault(LmiFile* f, LmiAllocator* a)}
		{parameter:
			{name: f}
...
*/
LmiFile* LmiFileConstructDefault(LmiFile* f, LmiAllocator* a);
...
/**
	{function:
		...
		{prototype: LmiFile* LmiFileConstruct(LmiFile* f, const char* path, LmiFileOpenFlag flags, LmiAllocator* a)}
		{parameter:
			{name: f}
...
*/
LmiFile* LmiFileConstruct(LmiFile* f, const char* path, LmiFileOpenFlag flags, LmiAllocator* a);
...
/**
	{function:
		...
		{prototype: LmiFile* LmiFileConstructFromFileHandle(LmiFile* f, LmiFileHandle handle, const char* path, LmiFileOpenFlag flags, LmiAllocator* a)}
		{parameter:
			{name: f}
			{description: The file object to construct.}}
 		{parameter:
...
*/
LmiFile* LmiFileConstructFromFileHandle(LmiFile* f, LmiFileHandle handle, const char* path, LmiFileOpenFlag flags, LmiAllocator* a);
