...
const char *VidyoTlsConfigGetCaStringCStr(const VidyoTlsConfig* c);
...
void VidyoTransportSetWebProxyDiscover(VidyoTransport* t, LmiBool discover);
LmiBool VidyoTransportGetWebProxyDiscover(const VidyoTransport* t);
...
LmiUint64 VidyoTransportGetBytesSentTcp(VidyoTransport* t);

LmiUint64 VidyoTransportGetBytesSentUdp(VidyoTransport* t);

LmiUint64 VidyoTransportGetBytesReceivedTcp(VidyoTransport* t);

LmiUint64 VidyoTransportGetBytesReceivedUdp(VidyoTransport* t);
...
VidyoLmiTransportAddress *VidyoTransportSetTurnLocalAddress(VidyoTransport* t, VidyoLmiTransportAddress* address, VidyoLmiTransport* turnTransport, const VidyoTlsConfig *tlsConfig, LmiBool startSecure);
