...
/**
 {type visibility="public":
	...
	{value: {name: VIDYO_ROOMINVITERESULT_NoResponse} {description: The server did
 not respond in a reasonable amount of time to the request to invite user to the room.}}
	{value: {name: VIDYO_ROOMINVITERESULT_Unauthorized} {description: The user does not have
 sufficient privileges to invite user to the room it requested.}}
	{value: {name: VIDYO_ROOMINVITERESULT_OutOfResources} {description: The server cannot
 delete rooms at the current time because it is out of some resource.}}
...
/**
{function:
	{name: VidyoRoomSetMaxBitRate}
	{parent: VidyoRoom}
	{description: }
	{prototype: void VidyoRoomSetMaxBitRate(VidyoRoom *r, LmiUint bitRate)}
	{parameter:
		{name: r}
		{description: }
	}
...
*/
void VidyoRoomSetMaxBitRate(VidyoRoom *r, LmiUint bitRate);
...
{function:
	...
	{parent: VidyoRoom}
	{description: }
	{prototype: void VidyoRoomAddLocalRenderer(const VidyoRoom *r, const VidyoLocalRenderer *localRenderer, LmiBool removeOthers)}
	{parameter:
		{name: r}
		{description: Vidyo room object.}
	}
...
*/
void VidyoRoomAddLocalRenderer(const VidyoRoom *r, const VidyoLocalRenderer *localRenderer, LmiBool removeOthers);
...
{function:
	...
	{parent: VidyoRoom}
	{description: }
	{prototype: void VidyoRoomGetSelectedLocalCameras(const VidyoRoom *r, LmiVector(VidyoLocalCamera)* cameras)}
	{parameter:
		{name: r}
		{description: Vidyo room object.}
	}
...
*/
void VidyoRoomGetSelectedLocalCameras(const VidyoRoom *r, LmiVector(VidyoLocalCamera)* cameras);
...
{function:
	...
	{parent: VidyoRoom}
	{description: }
	{prototype: void VidyoRoomGetSelectedLocalMicrophones(const VidyoRoom *r, LmiVector(VidyoLocalMicrophone)* mics)}
	{parameter:
		{name: r}
		{description: Vidyo room object.}
	}
...
*/
void VidyoRoomGetSelectedLocalMicrophones(const VidyoRoom *r, LmiVector(VidyoLocalMicrophone)* mics);
...
{function:
	...
	{parent: VidyoRoom}
	{description: }
	{prototype: void VidyoRoomGetSelectedLocalSpeakers(const VidyoRoom *r, LmiVector(VidyoLocalSpeaker)* speakers)}
	{parameter:
		{name: r}
		{description: Vidyo room object.}
	}
...
*/
void VidyoRoomGetSelectedLocalSpeakers(const VidyoRoom *r, LmiVector(VidyoLocalSpeaker)* speakers);
...
{function:
	...
	{parent: VidyoRoom}
	{description: }
	{prototype: void VidyoRoomGetSelectedLocalRenderers(const VidyoRoom *r, LmiVector(VidyoLocalRenderer)* renderers)}
	{parameter:
		{name: r}
		{description: Vidyo room object.}
	}
...
*/
void VidyoRoomGetSelectedLocalRenderers(const VidyoRoom *r, LmiVector(VidyoLocalRenderer)* renderers);
...
{function:
	...
	{parent: VidyoRoom}
	{description: }
	{prototype: void VidyoRoomGetSelectedLocalWindowShares(const VidyoRoom *r, LmiVector(VidyoLocalWindowShare)* windowShares)}
	{parameter:
		{name: r}
		{description: Vidyo room object.}
	}
...
*/
void VidyoRoomGetSelectedLocalWindowShares(const VidyoRoom *r, LmiVector(VidyoLocalWindowShare)* windowShares);
...
{function:
	...
	{parent: VidyoRoom}
	{description: }
	{prototype: void VidyoRoomGetSelectedLocalMonitors(const VidyoRoom *r, LmiVector(VidyoLocalMonitor)* monitors)}
	{parameter:
		{name: r}
		{description: Vidyo room object.}
	}
...
*/
void VidyoRoomGetSelectedLocalMonitors(const VidyoRoom *r, LmiVector(VidyoLocalMonitor)* monitors);
...
/**
 {function:
	...
	{prototype: LmiBool VidyoRoomBootParticipant(VidyoRoom *r, const LmiString* userId, const LmiString* reason)}
 ...
 */
LmiBool VidyoRoomBootParticipant(VidyoRoom *r, const LmiString* userId, const LmiString* reason);
...
/**
 {function:
	...
	{prototype: LmiBool VidyoRoomBootAllParticipants(VidyoRoom *r, const LmiString* reason)}
	{parameter: {name: r} {description: Vidyo room object.}}
	{parameter: {name: reason} {description: A message explaining the reason for the booting. This can be NULL if no message is desired.}}
	{return: LMI_TRUE if successful, LMI_FALSE otherwise.}
 }
 */
LmiBool VidyoRoomBootAllParticipants(VidyoRoom *r, const LmiString* reason);
