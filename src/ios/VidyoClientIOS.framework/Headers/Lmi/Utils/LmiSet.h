...
#define Declare_LmiSetEqual(K_)                  Declare_LmiBinaryTreeEqual(LmiSet(K_))
#define Define_LmiSetEqual(K_)                   Define_LmiBinaryTreeEqual(LmiSet(K_), K_)
#define Define_LmiSetEqual_Static(K_)            Define_LmiBinaryTreeEqual_Static(LmiSet(K_), K_)
#define LmiSetEqualComp(K_, Comp_)               LmiBinaryTreeEqualComp(LmiSet(K_), Comp_)
#define Declare_LmiSetEqualComp(K_, Comp_)       Declare_LmiBinaryTreeEqualComp(LmiSet(K_), Comp_)
#define Define_LmiSetEqualComp(K_, Comp_)        Define_LmiBinaryTreeEqualComp(LmiSet(K_), Comp_)
#define Define_LmiSetEqualComp_Static(K_, Comp_) Define_LmiBinaryTreeEqualComp_Static(LmiSet(K_), Comp_)
...
#define Declare_LmiMultisetEqual(K_)                  Declare_LmiBinaryTreeEqual(LmiMultiset(K_))
#define Define_LmiMultisetEqual(K_)                   Define_LmiBinaryTreeEqual(LmiMultiset(K_), K_)
#define Define_LmiMultisetEqual_Static(K_)            Define_LmiBinaryTreeEqual_Static(LmiMultiset(K_), K_)
#define LmiMultisetEqualComp(K_, Comp_)               LmiBinaryTreeEqualComp(LmiMultiset(K_), Comp_)
#define Declare_LmiMultisetEqualComp(K_, Comp_)       Declare_LmiBinaryTreeEqualComp(LmiMultiset(K_), Comp_)
#define Define_LmiMultisetEqualComp(K_, Comp_)        Define_LmiBinaryTreeEqualComp(LmiMultiset(K_), Comp_)
#define Define_LmiMultisetEqualComp_Static(K_, Comp_) Define_LmiBinaryTreeEqualComp_Static(LmiMultiset(K_), Comp_)
